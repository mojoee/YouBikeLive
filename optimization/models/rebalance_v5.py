...
def rebalance_v5(instance_path, solution_path, time_limit, routes_init=None):
    """
...
if __name__ == "__main__":
    ...
    solution_dir = "./results/v5/v12-24-24_b8h_d12/NTU_300s/"
    time_limit = 300
    ...
    rebalance_v5(instance_path, solution_path, time_limit)
