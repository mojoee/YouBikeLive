...
def rebalance_v5_1(instance_path, solution_path, time_limit, routes_init=None):
    """
    ...
    with hexaly.optimizer.HexalyOptimizer() as optimizer:
        ...
        total_duration = model.sum(routes_costs)
        ...
        result["objectives"] = [
            ...
            {"name": "max_duration", "value": sol.get_value(total_duration), "bound": sol.get_objective_bound(1), "gap": sol.get_objective_gap(1)}
            ]
        result["routes"] = []
        for k in range(vehicles_cnt):
...
if __name__ == "__main__":
    ...
    solution_dir = "./results/v5_1/v12-24-24_b8h_d12/NTU_300s/"
    time_limit = 300
    ...
    rebalance_v5_1(instance_path, solution_path, time_limit)
